...
if promptyn "Você deseja mudar o greeter do LightDM para o GTK? (s/n)"; then
  ...
  sudo wget -O /usr/local/bin/nvidia_lightdm_display_setup.sh https://github.com/rauldipeas/Unity-XP/raw/master/code/settings/nvidia_lightdm_display_setup.sh
