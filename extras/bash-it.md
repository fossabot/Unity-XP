...
unzip DroidSansMono.zip -d ~/.fonts;rm -rfv DroidSansMono.zip
...
```
[![bashrun-url](../resources/bashrun.png)](br://https://raw.githubusercontent.com/rauldipeas/Unity-XP/master/extras/bash-it.md)